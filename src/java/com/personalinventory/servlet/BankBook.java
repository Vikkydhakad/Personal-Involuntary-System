...
public class BankBook extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            BankBookDAO cdb = new BankBookDAO();
            ArrayList<BankBookBean> al = cdb.findAllDateWise(sdate, edate, x);
            ...
            out.println("<h1 style='margin-left:5%;'><font color='white'>BankBook</font><h1>");
            out.println("<div id='expenses'>");
            out.println("<center><form action='BankBook'>");
            out.println("<table><tr><td> <br>BankBook</td><td>DateFrom<br><input type='date' name='start'></td><td>To<br><input type='date' name='end'></td><td><br><input type='submit' value='Show'></td></table>");
            out.println("</form></center>");
            out.println("<center><table style='padding:10px;'>");
            out.println("<tr style='background-color:black;}'><th>S.No.</th><th>Date</th><th>Amount</th><th>Pay/Receive</th></tr>");
            
            int i=0;
            for(BankBookBean k:al){
                i++;
            out.println("<tr>");
