...
public class Expenses extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ExpensesCategoryDAO icb = new ExpensesCategoryDAO();
            ArrayList<ExpensesCategoryBean> y = icb.findAllIncomeByUserid(x);
            ...
            out.println("<h1 style='margin-left:5%;'><font color='white'>Expenses</font><h1>");
            out.println("<div id='expenses'>");
            out.println("<center><form action='addExpenses'>");
            out.println("<table>");
            out.println("<tr>");
            ...
            for (ExpensesCategoryBean r : y) {
                out.println("<option value=" + r.getExp_catdetails() + ">" + r.getExp_catname() + "</option>");
            }
