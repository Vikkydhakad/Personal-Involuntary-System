 ...
 * @author HOME
 */
public class EditIncomeCategory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            IncomeCategoryBean a = id.findByCatId(x);
            ...
            out.println("<form action='UpdateIncomeCategory'>");
            out.println("<center><table><tr><td>Category Name : </td><td><input type='text' name='name' value="+a.getInc_catname()+" ></td></tr>");
            out.println("<tr><td>Category Details : </td><td><input type='test' name='detail' value="+a.getInc_catdetails()+"></td></tr><tr><td><input type='hidden' value="+x+" name='id'></td><td><input type='submit' value='ADD' ></td></tr></table></center>");
            out.println("</form>");
            out.println("</div>");
            out.println("</body>");
            out.println("</html>");
