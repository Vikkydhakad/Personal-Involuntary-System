 ...
 * @author HOME
 */
public class IncomeCategoryAdd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1 style='margin-left:5%;'><font color='white'>Income Category</font><h1>");
            out.println("<form action='AddIncomeCategory'>");
            ...
            out.println("<tr>");
            out.println("<td>"+a.getInc_catname()+"</td>");
            out.println("<td>"+a.getInc_catdetails()+"</td>");
            out.println("<td><a href='EditIncomeCategory?id="+a.getInc_catid()+"'>Edit</a></td>");
            out.println("<td><a href='DeleteIncomeCategory?id="+a.getInc_catid()+"'>Delete</a></td>");
            out.println(" </tr>");
            }
